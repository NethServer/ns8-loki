...
| [insights](#insights)                     | `object`  | Required | cannot be null | [Configuration of Loki](get-configuration-properties-insights-collector.md "http://schema.nethserver.org/loki/get-configuration.json#/properties/insights")         |
...
* Type: `object` ([Insights collector](get-configuration-properties-insights-collector.md))

* cannot be null

* defined in: [Configuration of Loki](get-configuration-properties-insights-collector.md "http://schema.nethserver.org/loki/get-configuration.json#/properties/insights")
