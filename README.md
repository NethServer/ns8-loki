...
* [Configure the insights collector](./set-insights.md "Configure the collector that ships deduplicated log bundles to the nethesis-insights service") – `http://schema.nethserver.org/loki/set-insights.json`

## Other Schemas

### Objects

* [Insights collector](./get-configuration-properties-insights-collector.md "State of the collector that ships deduplicated log bundles to the nethesis-insights service") – `http://schema.nethserver.org/loki/get-configuration.json#/properties/insights`
